...
<head>
    ...
    <!-- Google Fonts -->
{{--    <link href="https://fonts.googleapis.com/css?family=Open+samim:300,400,400i,600,700|Raleway:300,400,400i,500,500i,700,800,900" rel="stylesheet">--}}
...
{{--                                </li>--}}
                                ...
                                <li>
                                    <a class="page-scroll" href="#portfolio">گالری</a>
                                </li>
                                <li>
                                ...
                                <li class="active">
                                    <a class="page-scroll" href="#home">خانه</a>
                                </li>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 ">
                <div class="well-middle">
                    <div class="single-well">
                        <a href="#">
                            <h4 class="sec-head">ایران آبنما مجری پروژه های آبنمایی</h4>
                        </a>
                        <p>
                            ایران آبنما ایران آبنما ایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنماایران آبنما ایران آبنما
                        </p>
                        <ul>
                            <li>
                                <i class="fa fa-check"></i>  آبنمای داخلی
                            </li>
                            <li>
                                <i class="fa fa-check"></i>آبنمای مبدانی
                            </li>
                            <li>
                                <i class="fa fa-check"></i> آبنمای موزیکال
                            </li>
                            <li>
                                <i class="fa fa-check"></i> پرژکتور آبنمایی
                            </li>
                            <li>
                                <i class="fa fa-check"></i> نازل آبنمایی
                            </li>
                        </ul>
                    </div>
                </div>
